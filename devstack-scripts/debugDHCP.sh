...
#neutron router-interface-add r1 sub3 ### for testing
#neutron router-interface-add r1 sub4 ### for testing
#sleep 3

testnovaboot-control.sh net1 client_sg 1 #"bekind" 
testnovaboot-control.sh net2 client_sg 2

#testnovaboot-compute.sh net3 client_sg 3  ### for testing
#testnovaboot-compute.sh net4 client_sg 4  ### for testing
