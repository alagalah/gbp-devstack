...
neutron security-group-rule-create client_sg --remote-group-id video_sg --direction egress --ethertype IPv4
neutron security-group-rule-create client_sg --remote-group-id video_sg --direction ingress --ethertype IPv4
